...
mod tests {
    ...
    fn test_find_max_version_in_directory() {
        ...
        // Should find the max version as (2, 0)
        assert_eq!(find_max_version_in_directory(temp_dir.path()), Some((2, 0)));

        // Cleanup is automatic with assert_fs
    }
