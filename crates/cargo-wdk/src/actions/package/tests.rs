...
#[test]
pub fn given_a_driver_project_when_profile_is_release_and_target_arch_is_x86_64_then_it_builds_successfully() {
    // Input CLI args
    let cwd = PathBuf::from("C:\\tmp");
    let profile = Profile::Release;
...
impl TestPackageAction {
    fn new(cwd: PathBuf, profile: Profile, mut target_arch: TargetArch, sample_class: bool) -> Self {
